    ...
    <div className="hero-section h-auto relative pt-32 items-center justify-center pb-28">
      <div className="hero-container relative flex-col items-center">
        ...
        <div className="frame-heroimg relative z-10 flex w-full justify-center pt-56">
          <div className="frame-responsive flex relative mx-auto">
            <Image src={heroImages.FashionSvg} alt="FashionSvg" className="fashionsvg absolute" height={97} width={190} />
            ...
            <Image src={heroImages.heroIMG4} alt="Muse4" loading="lazy" width={500} height={680} objectFit="cover" objectPosition="center" className="flex-shrink-0 z-10" />
            <Image src={heroImages.Adora} alt="adora" className="adorasvg absolute" width={180} height={68} />
          </div>
        </div>
      </div>
    </div>
