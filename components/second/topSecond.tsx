  ...
  return (
    <div className="topSecond relative mx-24 mb-36 flex gap-3 items-center justify-center">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
        <g clip-path="url(#clip0_2383_215)">
          <path
          ...
          <path d="M32.8125 29.6875C31.1914 32.4902 28.4707 34.375 25 34.375C21.5293 34.375 18.8086 32.4902 17.1875 29.6875" stroke="black" strokeWidth="2" stroke-linecap="round" stroke-linejoin="round" />
        </g>
        <defs>
